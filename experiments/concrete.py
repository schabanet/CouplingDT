...
if __name__ == "__main__":
    ...
    if SAVE:
        pkl.dump([rep_GSM_ML_error,
                    ...
                    rep_Con_coupling_regret,
                    rep_Con_b],
                    open("C:/Users/Sylvain Chabanet/OneDrive - Universite de Lorraine/Documents/these/experimental/python/Coupling/multi_dataset/results/CCST40_2.pkl", "wb")
                )
